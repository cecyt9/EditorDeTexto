package edu.ipn.cecyt9.editordetexto;
...
public EditorDeTexto(String title) 
{
	super(title);
}
...
public void askSave() 
{
	...
	//Dialogo modal SI_NO
	int ret=optionPane.showOptionDialog(this,"¿Desea guardar el archivo? ","Pregunta",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE,null,opciones,opciones[0]);
...
public void initialize()
{
	...
	openButton.setIcon(new ImageIcon(getClass().getResource("../imagenes/open.gif")));
	openButton.setMargin(new Insets(0, 0, 0, 0));
	toolBar.add(openButton);
	
	saveButton = new JButton();
	saveButton.setIcon(new ImageIcon(getClass().getResource("../imagenes/save.gif")));
	...
	copyButton.setIcon(new ImageIcon(getClass().getResource("../imagenes/copy.gif")));
	copyButton.setMargin(new Insets(0, 0, 0, 0));
	toolBar.add(copyButton);
	
	cutButton = new javax.swing.JButton();
	cutButton.setIcon(new ImageIcon(getClass().getResource("../imagenes/cut.gif")));
	cutButton.setMargin(new Insets(0, 0, 0, 0));
	toolBar.add(cutButton);
	
	pasteButton = new javax.swing.JButton();
	pasteButton.setIcon(new ImageIcon(getClass().getResource("../imagenes/paste.gif")));
...
{
	EditorDeTexto aplication = new EditorDeTexto("Editor simple");
